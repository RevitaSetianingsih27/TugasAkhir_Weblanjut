                    ...
                    <div class="card">
                        <div class="card-header ">
                            <h3 class="card-title mt-2">
                                Form Input Data Pengeluaran Hari ini
                            </h3>
                            <a href="/outcomeHarian" class="btn btn-danger float-right"><i class='fas fa-arrow-left mr-2'></i>BACK</a>
                        ...
                        <div class="card-body">
                            <div class="tab-content p-0">
                                <div class="container-fluid d-flex">
                                    <form action="/saveKeluarH" method="post">
                                        <div class="mb-3">
