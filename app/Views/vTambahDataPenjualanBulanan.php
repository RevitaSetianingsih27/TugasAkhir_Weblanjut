                    ...
                    <div class="card">
                        <div class="card-header ">
                            <h3 class="card-title mt-2">
                                Form Input Data Penjualan Bulanan
                            </h3>
                        ...
                        <div class="card-body">
                            <div class="tab-content p-0">
                                <div class="container-fluid">
                                    <form action="/saveJualB" method="post">
                                    <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Tanggal</label>
                                            <input type="date" name="tanggal" class="form-control" autofocus id="exampleInputEmail1" size="100%">
                                        </div>
                                        <div class="mb-3">
