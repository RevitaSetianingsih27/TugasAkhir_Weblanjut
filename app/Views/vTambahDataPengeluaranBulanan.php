                    ...
                    <div class="card">
                        <div class="card-header ">
                            <h3 class="card-title mt-2">
                                Form Input Data Pengeluaran Bulanan
                            </h3>
                            <a href="/outcomeBulanan" class="btn btn-danger float-right"><i class='fas fa-arrow-left mr-2'></i>BACK</a>
                        ...
                        <div class="card-body">
                            <div class="tab-content p-0">
                                <div class="container-fluid d-flex">
                                    <form action="/saveKeluarB" method="post">
                                    <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Tanggal</label>
                                            <input type="date" class="form-control" autofocus id="exampleInputEmail1" size="75%">
                                        </div>
                                        <div class="mb-3">
